...
namespace HomeTask4
{
    ...
    {   // same Box
        public double squarePerimeterBox    { get;  set; }
        public double rectanglePerimeterBox { get;  set; }
        public double trianglePerimeterBox { get;  set; }

        public double squareSquareBox { get;  set; }
        public double rectangleSquareBox { get;  set; }
        public double triangleSquareBox { get;  set; }
        public double hexagonSquareBox { get;  set; }
        public double rhombusSquareBox { get;  set; }
